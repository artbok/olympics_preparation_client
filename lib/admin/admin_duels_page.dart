  ...
  Future<void> fetchDuels() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('${getValue("serverAddress")}/get-duels'),
  ...
  Future<void> cancelDuel(int duelId) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('${getValue("serverAddress")}/cancel-duel'),
        headers: {'Content-Type': 'application/json'},
  ...
  Widget build(BuildContext context) {
    ...
    return scaffoldWithAdminNavigation(
      ...
      AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.refresh), onPressed: fetchDuels),
        ],
      ),
      Center(
        child: isLoading
                  ...
                  return Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: isCancelled ? Colors.grey[300] : colors.surface,
